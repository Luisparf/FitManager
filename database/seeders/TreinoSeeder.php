...
class TreinoSeeder extends Seeder
{
    ...
    public function run()
    {
        Treino::create([
            ...
            'info_extra' => 'Realize pelo menos 3 séries de 10 repetições com 60 segundos de descanso entre as séries.',
